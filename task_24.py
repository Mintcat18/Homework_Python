...
for i in range(n):
    curr_berries = berries[i] + berries[(i+1)%n] + berries[(i-1)%n] # собираем ягоды с текущего куста и его соседей
    max_berries = max(max_berries, curr_berries) # сохраняем максимальное количество ягод
